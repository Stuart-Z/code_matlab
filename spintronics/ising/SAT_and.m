...
%         I1=I*(-2+2*m2_read+2*m3_read)+2*I;
%         I2=I*(1+2*m1_read-m3_read)+2*I;
%         I3=I*(1+2*m1_read-m2_read);
        
        I1=3*I*(m2_read+m3_read+1);
        I2=-1*10^-6;
        I3=1*10^-6;
...
%% plot
pb1=m1_positive/(m1_positive+m1_negtive);
pb2=m2_positive/(m2_positive+m2_negtive);
pb3=m3_positive/(m3_positive+m3_negtive);
figure;
subplot(3,1,1);
