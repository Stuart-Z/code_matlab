...
for x=1:1:1
    ...
    for i=1:1:30
        ...
        logits_weights_s11=LFSR(6,bit,logits_weights(1,1));logits_weights_s12=LFSR(6,bit,logits_weights(1,2));logits_weights_s13=LFSR(6,bit,logits_weights(1,3));
        logits_weights_s21=LFSR(7,bit,logits_weights(2,1));logits_weights_s22=LFSR(7,bit,logits_weights(2,2));logits_weights_s23=LFSR(7,bit,logits_weights(2,3));
        logits_weights_s31=LFSR(8,bit,logits_weights(3,1));logits_weights_s32=LFSR(8,bit,logits_weights(3,2));logits_weights_s33=LFSR(8,bit,logits_weights(3,3));
        logits_weights_s41=LFSR(9,bit,logits_weights(4,1));logits_weights_s42=LFSR(9,bit,logits_weights(4,2));logits_weights_s43=LFSR(9,bit,logits_weights(4,3));
