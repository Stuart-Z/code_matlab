...
%                 logits_weights_s(m,n)=s_bit(logits_weights(m,n)*bits_length,bits_length);
        ...
        %放缩10倍后的计算
%         voltage_1=(test_s(1)*layer1_weights_s(1,1)-test_s(2)*layer1_weights_s(2,1)+test_s(3)*layer1_weights_s(3,1)+test_s(3)+test_s(4)+test_s(4)*layer1_weights_s(4,1)-layer1_biases_s(1))/4;
%         voltage_2=(test_s(1)*layer1_weights_s(1,2)-test_s(2)*layer1_weights_s(2,2)+test_s(3)*layer1_weights_s(3,2)+test_s(3)+test_s(4)+test_s(4)*layer1_weights_s(4,2)-layer1_biases_s(2))/4;
%         voltage_3=-(test_s(1)*layer1_weights_s(1,3)-test_s(2)*layer1_weights_s(2,3)+test_s(3)*layer1_weights_s(3,3)+test_s(3)+test_s(4)+test_s(4)*layer1_weights_s(4,3)-layer1_biases_s(3))/4;
%         voltage_4=-(test_s(1)*layer1_weights_s(1,4)-test_s(2)*layer1_weights_s(2,4)+test_s(3)*layer1_weights_s(3,4)+test_s(3)+test_s(4)+test_s(4)*layer1_weights_s(4,4)-layer1_biases_s(4))/4;
        %放缩15倍的计算
        ...
        layer1_1=sigmf(voltage_1,[6,0]);
        layer1_2=sigmf(voltage_2,[6,0]);
        layer1_3=sigmf(voltage_3,[6,0]);
        layer1_4=sigmf(voltage_4,[6,0]);
